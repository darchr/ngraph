...
bool op::util::ArithmeticReduction::reduction_axes_constant() const
{
    ...
    return dynamic_pointer_cast<op::Constant>(input(1).get_source_output().get_node_shared_ptr()) != nullptr;
}
...
const AxisSet op::util::ArithmeticReduction::get_reduction_axes() const
{
    ...
    if (auto const_op = dynamic_pointer_cast<op::Constant>(input(1).get_source_output().get_node_shared_ptr()))
    {
